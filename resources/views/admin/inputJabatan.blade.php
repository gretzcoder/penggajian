                    ...
                    <div class="card-body">
                        <form action="{{ url('admin/jabatan/input-jabatan') }}" method="POST">
                            ...
                            <div class="input-group mb-3">
                              ...
                              <input type="text" aria-describedby="basic-addon1" class="form-control uang @error('gaji') is-invalid @enderror" id="gaji" name="gaji" value="{{ old('gaji') }}">
                              @error('gaji')
                              <div class="invalid-feedback">
                                {{ $message }}
                              </div>
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" aria-describedby="basic-addon2" class="form-control uang @error('tunjangan') is-invalid @enderror" id="tunjangan" name="tunjangan" value="{{ old('tunjangan') }}">
                              @error('tunjangan')
                              <div class="invalid-feedback">
                                {{ $message }}
                              </div>
