...
@section('title', 'Kelola '.$position->position)
		                ...
		                <div class="col-md-12 overflow-auto">
                            <form action="{{ url('admin/jabatan/'.$position->id.'/edit') }}" method="POST">
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control @error('jabatan') is-invalid @enderror" id="jabatan" name="jabatan" value="{{ $position->position }}">
                                  @error('jabatan')
                                ...
                                <div class="input-group mb-3">
                                  ...
                                  <input type="text" aria-describedby="basic-addon1" class="form-control uang @error('gaji') is-invalid @enderror" id="gaji" name="gaji" value="{{ $position->salary }}">
                                  @error('gaji')
                                  <div class="invalid-feedback">
                                    {{ $message }}
                                  </div>
                                ...
                                <div class="input-group">
                                  ...
                                  <input type="text" aria-describedby="basic-addon2" class="form-control uang @error('tunjangan') is-invalid @enderror" id="tunjangan" name="tunjangan" value="{{ $position->job_allowance }}">
                                  @error('tunjangan')
                                  <div class="invalid-feedback">
                                    {{ $message }}
                                  </div>
                            ...
                            <div class="modal fade" id="jabatanModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
		            ...
		            <div class="row">
                        <div class="col-md-12 overflow-auto">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataPositionPegawai" width="100%" cellspacing="0">
                                <thead>
                                    <tr>
                                    <th>Nip</th>
                                    <th>Nama Lengkap</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-info btn-sm" style="width: 60px;" href="{{ url('admin/data-karyawan/'.$employee->id) }}" role="button">Lihat</a>
                                            <button type="button" class="btn btn-warning btn-sm mx-1" style="width: 60px;" data-toggle="modal" data-target="#exampleModalCenter{{ $employee->id }}">Ubah</button>
                                            <button type="button" class="btn btn-danger btn-sm d-inline" style="width: 60px;" data-toggle="modal" data-target="#exampleModalCenter2{{ $employee->id }}">Hapus</button>
                                        </td>
                                    </tr>
                                    ...
                                    <div class="modal fade" id="exampleModalCenter{{ $employee->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                        <form action="{{ url('admin/jabatan/'.$employee->id) }}" method="POST" enctype="multipart/form-data">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLongTitle">Ubah Jabatan Pegawai</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                            </div>
                                        ...
                                        {{-- Delete Modal --}}
                                        <div class="modal fade" id="exampleModalCenter2{{ $employee->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-footer p-0 px-3">
                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                                                <form method="POST" action="{{ url('/admin/akun/'.$employee->id) }}" class="m-0 p-0">
                                                    @csrf
                                                    @method('delete')
                                                    <div class="form-group">
                                                        <input type="submit" class="mt-3 btn btn-danger" value="Hapus">
