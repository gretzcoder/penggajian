                        ...
                        <form action="{{ url('admin/akun/'.$employee->user->id) }}" method="POST">
                          ...
                          @method('patch')
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control @error('password') is-invalid @enderror" id="exampleInputPassword2" name="password" required>
                                    @error('password')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control @error('cpassword') is-invalid @enderror" id="exampleInputPassword3" name="cpassword" required>
                                    @error('cpassword')
                                    <div class="invalid-feedback">
                                      {{ $message }}
                                    </div>
		...
		<div class="col-md-8">
		    <div class="card">
		        <div class="card-body">
		            ...
		            <div class="row">
		                <div class="col-md-12 overflow-auto">
                        <form action="{{ url('admin/data-karyawan/'.$employee->id) }}" method="POST" enctype="multipart/form-data">
                          @csrf
                          @method('patch')
                              <div class="form-group row">
                                <label for="username" class="col-4 col-form-label">Nip</label> 
                                <div class="col-8">
                                  <input id="username" name="nip" value="{{ $employee->user->nip }}" class="form-control here @error('nip') is-invalid @enderror" required="required" type="text" readonly>
                                </div>
                              </div>
                              <div class="form-group row">
                                <label for="name" class="col-4 col-form-label">Nama Lengkap</label> 
                                <div class="col-8">
                                  <input id="name" name="nama" value="{{ $employee->full_name }}" required class="form-control here @error('nama') is-invalid @enderror" type="text">
                                  @error('nama')
                                  <div class="invalid-feedback">
                                    {{ $message }}
                                  </div>
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-8">
                                  <textarea class="form-control here @error('alamat') is-invalid @enderror" id="validationTextarea" name="alamat" required>{{ $employee->address }}</textarea>
                                  @error('alamat')
                                  <div class="invalid-feedback">
                                    {{ $message }}
                                  </div>
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-8">
                                  <input id="text" name="telp" class="form-control here @error('telp') is-invalid @enderror" required="required" type="text" maxlength="12" value="{{ $employee->phone }}">
                                  @error('telp')
                                  <div class="invalid-feedback">
                                    {{ $message }}
                                  </div>
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-8">
                                    <select class="form-control @error('pernikahan') is-invalid @enderror" id="marital" name="pernikahan">
                                                <option selected value="{{ $employee->marital_status ? 1 : 0}}">{{ $employee->marital_status ? 'Kawin' : 'Belum Kawin' }}</option>
                                                <option value="{{ $employee->marital_status ? 0 : 1 }}">{{ $employee->marital_status ? 'Belum Kawin' : 'Kawin' }}</option>
                                    </select>
                                  @error('pernikahan')
                                  <div class="invalid-feedback">
                                    {{ $message }}
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-8">
                                  <input id="anak" name="anak" class="form-control here @error('anak') is-invalid @enderror" required="required" type="text" maxlength="12" value="{{ $employee->number_of_children }}">
                                  @error('anak')
                                  <div class="invalid-feedback">
                                    {{ $message }}
                                  </div>
                              ...
                              <div class="form-group row justify-content-end mr-1">
                                  <a href="{{ url('admin/data-karyawan/'.$employee->id) }}" class="btn btn-secondary mr-3">Lihat Profile</a>
                                  <button name="submit" type="submit" class="btn btn-primary">Update</button>
                              </div>
                            </form>
		                </div>
