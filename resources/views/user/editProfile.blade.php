                        ...
                        <form action="{{ url('profile/update-password') }}" method="POST">
                          ...
                          @method('patch')
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control @if (session()->has('password_salah')) is-invalid @endif" id="exampleInputPassword1" name="oldpassword" required>
                        ...
                        <form action="{{ url('profile/update-profile') }}" method="POST" enctype="multipart/form-data">
                          ...
                          @method('patch')
                              <div class="form-group row">
                                ...
                                <div class="col-8">
                                  <input id="username" value="{{ $employee->user->nip }}" class="form-control here " required="required" type="text" readonly>
                                </div>
                              </div>
                              <div class="form-group row">
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-8">
                                  <input id="lastname" value="{{ $employee->position->position }}" class="form-control here" type="text" readonly>
                                </div>
                              </div>
                              <div class="form-group row">
