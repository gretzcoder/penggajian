                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <input type="password" class="form-control @error('password') is-invalid @enderror" name="cpassword" id="exampleInputPassword1">
                                @error('cpassword')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                ...
                <div class="modal-content px-3">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-8">
                            <input id="username" placeholder="{{ $employee->user->nip }}" class="form-control here  @error('nip') is-invalid @enderror" required="required" type="text" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="name" class="col-4 col-form-label">Nama Lengkap</label> 
                            <div class="col-8">
                              <input id="name" placeholder="{{ $employee->full_name }}" required class="form-control here @error('nama') is-invalid @enderror" required type="text" readonly>
                              @error('nama')
                              <div class="invalid-feedback">
                                {{ $message }}
                              </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-8">
                              <input id="name" placeholder="{{ $employee->position->position }}" required class="form-control here @error('nama') is-invalid @enderror" required type="text" readonly>
                              @error('nama')
                              <div class="invalid-feedback">
                                {{ $message }}
                              </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-8">
                              <textarea class="form-control here @error('alamat') is-invalid @enderror" id="validationTextarea" name="alamat" required>{{ old('alamat') }}</textarea>
                              @error('alamat')
                              <div class="invalid-feedback">
                                {{ $message }}
                              </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-8">
                              <input id="text" name="telp" class="form-control here @error('telp') is-invalid @enderror" required="required" type="text" maxlength="12" value="{{ old('telp') }}">
                              @error('telp')
                              <div class="invalid-feedback">
                                {{ $message }}
                              </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-8">
                                <select class="form-control @error('pernikahan') is-invalid @enderror" id="marital" name="pernikahan" required>
                                            <option selected value="{{ old('pernikahan') ? 1 : 0 }}">{{ old('pernikahan') ? 'Kawin' : 'Belum Kawin' }}</option>
                                            <option value="{{ old('pernikahan') ? 0 : 1 }}">{{ old('pernikahan') ? 'Belum Kawin' : 'Kawin' }}</option>
                                </select>
                              @error('pernikahan')
                              <div class="invalid-feedback">
                                {{ $message }}
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-8">
                              <input id="text" name="anak" class="form-control here @error('anak') is-invalid @enderror" required="required" type="text" maxlength="12" value="{{ old('anak') }}">
                              @error('anak')
                              <div class="invalid-feedback">
                                {{ $message }}
                              </div>
